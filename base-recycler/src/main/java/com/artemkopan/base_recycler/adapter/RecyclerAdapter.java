...
import com.artemkopan.base_recycler.holder.BaseHolder;
import com.artemkopan.base_recycler.listeners.OnItemClickListener;
...
public abstract class RecyclerAdapter<M, VH extends ViewHolder> extends RecyclerView.Adapter<VH> {
